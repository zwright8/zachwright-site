...
const requiredInstructionsPageMarkers = [
  ...
  "the $249 tier is capped at 120 total WrightOps labor minutes",
  "$249: root AGENTS.md plus one selected companion, maximum 120 labor minutes",
  '<option value="root CONTRIBUTING.md">Root CONTRIBUTING.md workflow checklist</option>',
  '"root CONTRIBUTING.md",',
  "For the $249 two-file tier, choose root CLAUDE.md, .github/copilot-instructions.md, or root CONTRIBUTING.md as the companion.",
  "The root CONTRIBUTING.md workflow checklist is available only as the $249 companion to root AGENTS.md.",
...
const requiredInstructionsGuideMarkers = [
  ...
  "Filename case is exact",
  "claude.md",
  "Does the filename’s capitalization matter?",
...
const requiredAgentsSizeBudgetPageMarkers = [
  ...
  'id="secondary-next-step"',
  'href="/single-file-agent-instructions-correction/"',
  "Review the $149 correction boundary",
  'href="/agent-ready-repository-audit/#scope-builder"',
  "Review the $750 diagnostic audit",
  "const singleFileLineCap = 250",
  "function updateNextStep(lines)",
  "Line count fits the $149 single-file boundary.",
  "Too large for the $149 correction; start with the audit.",
  "It is a diagnostic and does not promise a rewritten file or repository changes.",
